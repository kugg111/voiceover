...
namespace Server.Migrations
{
    ...
    [Migration("20260722102942_ReplaceServerKeyWithPerMessageEnvelopeEncryption")]
    partial class ReplaceServerKeyWithPerMessageEnvelopeEncryption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voiceover.Server.Models.AdminAuditLogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Voiceover.Server.Models.BannedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Voiceover.Server.Models.Block", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Voiceover.Server.Models.DirectMessageReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Voiceover.Server.Models.GuildServer", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "IX_GuildServers_Name_Trgm");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex(new[] { "Name" }, "IX_GuildServers_Name_Trgm"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex(new[] { "Name" }, "IX_GuildServers_Name_Trgm"), new[] { "gin_trgm_ops" });
            ...
            modelBuilder.Entity("Voiceover.Server.Models.MessageReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Voiceover.Server.Models.ModerationLogEntry", b =>
                {
                    ...
                    b.HasIndex("GuildServerId", "CreatedAt");

                    b.ToTable("ModerationLogEntries");
                });
            ...
            modelBuilder.Entity("Voiceover.Server.Models.TotpRecoveryCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
